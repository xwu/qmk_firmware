...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_MUTE, KC_VOLD, KC_VOLU,            KC_PSCR, KC_SLCK, KC_PAUS, \
    ...
    [1] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_F10,  KC_F11,  KC_F12,             _______, _______, _______, \
        ...
        _______, RGB_TOG, _______, _______, _______, MD_BOOT, TG_NKRO, EEP_RST, _______, _______, _______, _______,                              _______, \
